...
export default function FinalCTA() {
  ...
  return (
    <section ref={ctaRef} className="py-52 px-6 relative overflow-hidden bg-bg-primary border-t border-white/5">
      ...
      <div className="cta-content max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="inline-block hover-target cursor-none group">
          <div className="relative px-12 py-8 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 bg-bg-secondary rounded-2xl border border-white/10 transition-transform duration-500 group-hover:scale-105 group-hover:border-accent-primary/50 overflow-hidden">
